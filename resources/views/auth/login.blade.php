                      ...
                      <div class="col-lg-6">
                        <div class="card-body p-md-5 mx-md-4">
                          ...
                          <div class="text-center">
                            ...
                            <h4 class="mt-1 mb-5 pb-1">Bienvenido a Ferremax</h4>
                          </div>
          
                          <form action="{{route('login')}}" method="POST">
                            @csrf
                            <p>Ingresa tu correo y constraseña</p>
                        ...
                        @endif
                            ...
                            <div class="d-flex align-items-center justify-content-center pb-4">
                              ...
                              <a  href="{{route('register')}}" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-danger">Crea una aquí</a>
                            </div>
